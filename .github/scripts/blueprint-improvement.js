...
INSTRUCTIONS:
1. Apply 2 rounds of ${thinkingMethods.join(", ")} from Edward de Bono's Six Thinking Hats to review the blueprint from the perspectives of ${perspectives.join(", ")}
2. Identify the ONE most critical weakness of the blueprint based on the insights of the review
3. Propose a concrete, detailed correction to the weakness. Ground it with internet search whenever necessary and include the sources if you do
...

{
  ...
  "description": "Detailed description of the proposed correction including sources (2-3 sentences)",
